...
public class AuthenticationRequest {
    ...
    @ApiModelProperty(required = true, name = "The unique name of the users", example = "admin")
    private String username;

    @ApiModelProperty(required = true, name = "The password of the users", example = "password")
